...
const Rubik = () => {
    ...
    const [cube, setOption, valueInput, setValueInput, executeMoves, activeButtonStep, resolveStepByStep, listAllMoves] = useRubikCube()
    ...
    return (
        <div className="container">
                                ...
                                <div className={`cara face${i}`} key={ i }>
                                    {
                                        face.map((row, k) => (
                                            row.map((carre, index) => (
                                                <div
                                                    key={ index }
                                                    className={ `inferiors ${(i === 0 && k === 1 && index === 1) ? "logo" : ""}` }
            ...
            <div>
                ...
                <ListMovement listAllMoves={ listAllMoves } />
                <TextInput
